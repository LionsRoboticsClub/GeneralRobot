...
void loop(){
    ...
    Serial.println(movement_data[1]);
    Serial.println(movement_data[2]);
    Serial.println(movement_data[3]);
    ...
    motor1.move((movement_data[0]));
    motor2.move((movement_data[1]));
    motor3.move((movement_data[2]));
    motor4.move((movement_data[3]));
