...
MecanumDrive::MecanumDrive(Motor A, Motor B, Motor C, Motor D, double angle, double magnitude, double rotationSpeed){
...
void MecanumDrive::moveTowards(double angle, double magnitude, double rotationSpeed){
    ...
    B.move(MAX_SPEED * magnitude * (cos(angle * PI / 180 + PI/4) - rotationSpeed));
